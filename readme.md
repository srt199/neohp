...
- The aim is to replace clunky, slow frameworks and go back to basics. Files that contains all HTML, JS, CSS and Backend code that are run by any server and shown immediately in any browser. PHP style but with Python's more modern syntax.
